          ...
          {/* <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="rounded-lg bg-card text-card-foreground group hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
              <div class="flex flex-col space-y-1.5 p-6">
                ...
                <h3 class="text-2xl font-semibold leading-none tracking-tight group-hover:text-primary transition-colors">Custom Wardrobe Design</h3>
              </div>
              <div class="p-6 pt-0">
                <p class="text-muted-foreground text-base">Tailor-made wardrobes designed to fit your space, style, and storage needs.</p>
              </div>
            </div> */}
          {/* <div class="rounded-lg bg-card text-card-foreground group hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
              <div class="flex flex-col space-y-1.5 p-6">
                <div class="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-building h-6 w-6 text-primary"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"></rect>
                    <path d="M9 22v-4h6v4"></path><path d="M8 6h.01"></path><path d="M16 6h.01"></path>
                    <path d="M12 6h.01"></path><path d="M12 10h.01"></path><path d="M12 14h.01"></path>
                    <path d="M16 10h.01"></path><path d="M16 14h.01"></path><path d="M8 10h.01"></path>
                    <path d="M8 14h.01"></path></svg></div><h3 class="text-2xl font-semibold leading-none tracking-tight group-hover:text-primary transition-colors">Office Furniture Solutions</h3></div><div class="p-6 pt-0">
                <p class="text-muted-foreground text-base">Durable cabinets and secure filing units tailored for corporate environments.</p>
              </div>
            </div>
            <div class="rounded-lg bg-card text-card-foreground group hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
              <div class="flex flex-col space-y-1.5 p-6">
                <div class="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-colors">
                  ...
                  </svg></div><h3 class="text-2xl font-semibold leading-none tracking-tight group-hover:text-primary transition-colors">High-Security Lockers</h3>
                <div>
                  <div class="p-6 pt-0">
                    <p class="text-muted-foreground text-base">Robust and secure lockers for personal, office, or industrial use.</p>
                  </div></div><div class="rounded-lg bg-card text-card-foreground group hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                  <div class="flex flex-col space-y-1.5 p-6"><div class="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wrench h-6 w-6 text-primary">
                      <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path></svg></div><h3 class="text-2xl font-semibold leading-none tracking-tight group-hover:text-primary transition-colors">Modular Cabinets</h3></div>
                  <div class="p-6 pt-0"><p class="text-muted-foreground text-base">Space-saving, modern cabinets that combine utility with aesthetics.</p>
                  </div>
                </div>
                <div class="rounded-lg bg-card text-card-foreground group hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                  <div class="flex flex-col space-y-1.5 p-6">
                    <div class="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shield h-6 w-6 text-primary">
                        <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path></svg></div><h3 class="text-2xl font-semibold leading-none tracking-tight group-hover:text-primary transition-colors">Kitchen Storage Solutions</h3>
                  </div> */}
